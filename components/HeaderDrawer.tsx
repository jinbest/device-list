...
import { SecondaryNavParams, SecondaryNavType, NavParams } from "../models/nav-params"
...
const HeaderDrawer = () => {
  ...
  const secondary = _.cloneDeep(config.headerData.navData.secondary)
        ...
        <div className="flex flex-column">
          <div>
            ...
            <div className="dynamic-contents-container custom-scroll-bar">
              <div className={menuStep === 0 ? "show" : "hide"}>
                <div
              ...
              <div className={menuStep === 1 && itemType === "popular" ? "show" : "hide"}>
                <div
                  className="drawer-nav-item"
                  onClick={() => {
                    setMenuStep(0)
              ...
              <div className={menuStep === 1 && itemType === "services" ? "show" : "hide"}>
                <div
                  className="drawer-nav-item"
                  onClick={() => {
                    setMenuStep(0)
              ...
              <div className={menuStep === 1 && itemType === "shop" ? "show" : "hide"}>
                <div
                  className="drawer-nav-item"
                  onClick={() => {
                    setMenuStep(0)
              ...
              <div className={menuStep === 2 ? "show" : "hide"}>
                <div
                  className="drawer-nav-item"
                  onClick={() => {
                    setMenuStep(1)
              ...
              <div className={menuStep === 3 ? "show" : "hide"}>
                <div
                  className="drawer-nav-item"
                  onClick={() => {
                    setMenuStep(2)
          ...
          <div
            className={menuStep === 0 ? "show" : "hide"}
            style={{ borderTop: "1px solid #B5B5B5", marginTop: "10px", padding: "10px 0" }}
          >
            <div
              className="drawer-nav-item"
              onClick={() => {
